...
var recordCmd = &cobra.Command{
	...
	Long:  `Updates a dns record of your domain name.Required flags - 'domain'.Optional flags = 'type'(record type of your dns record),'name'(record name of your dns record),'data'(value of the dns record - defaults to 3600),'ttl'(ttl of the dns record),'weight'(weight of the dns record - defaults to 1)`,
